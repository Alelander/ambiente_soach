        ...
        <div class="editor-container">
            ...
            <div class="editor-section">
                ...
                <textarea id="asunto-editor" class="tiny-editor">
                    <div class="template-variable">
                        <p>
                            MSc. Manuel Saúl Orellana Fierro <br><br>
            ...
            <div class="editor-section">
                ...
                <textarea id="asunto-editor" class="tiny-editor">
                    <div class="template-variable">
                        <p>
                            Pronunciamiento favorable al <span class="variable"><strong>[tipoObligacion]</strong></span> del proyecto "<span class="variable"><strong>[nombreProyecto]</strong></span>" período <span class="variable"><strong>[periodo]</strong></span>, <span class="variable"><strong>[numeroInforme]</strong></span>
                        </p>
                    </div>
                </textarea>
            </div>
